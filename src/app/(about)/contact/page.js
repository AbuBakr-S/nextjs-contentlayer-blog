...
const Contact = () => {
  return (
    <section className="w-full h-auto md:h-[75vh] border-solid border-b-2 dark:border-light flex flex-col md:flex-row items-center justify-center text-dark dark:text-light">
